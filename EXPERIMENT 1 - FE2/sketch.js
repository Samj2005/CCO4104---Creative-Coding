...
//variables for square features to be altered
...
//keys determine all the interactable keys available that do different things
...
function keyPressed(){
  if(key == 'g'){
    ...
    fill(0,50,200)
    circle(squareX,squareY,150)
  }else if(key == 'j'){
    fill(0,200,50)
    triangle(squareX+300,squareY+300,squareX+150,squareY+150,squareX-200,squareY-200)
  }else if(key == 'k'){
    fill(200,0,200)
    rect(squareX+20,squareY+20,400,300,20)
  }
}